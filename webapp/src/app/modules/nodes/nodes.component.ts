...
const ELEMENT_DATA: KbNodes = {
  ...
  [
    {metadata: {
                ...
                creationTimestamp: '',
                finalizers: [],
                labels: new Map([['beta.kubernetes.io/arch', 'Amd64'], ['node-role.kubernetes.io/master', 'true']]),
                managedFields: [],
    ...
    {metadata: {
                ...
                creationTimestamp: '',
                finalizers: [],
                labels: new Map([['beta.kubernetes.io/arch', 'Amd64'], ['node-role.kubernetes.io/worker', 'worker']]),
                managedFields: [],
